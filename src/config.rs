...
mod tests {
    ...
    #[test]
    fn test_parse_multiple_summoners() {
    ...
    #[test]
    fn test_parse_summoner_with_spaces() {
    ...
    #[test]
    fn test_parse_summoner_with_hyphens() {
    ...
    #[test]
    fn test_parse_summoner_with_underscores() {
    ...
    #[test]
    fn test_valid_summoner_name() {
        assert!(is_valid_summoner_name("Catory"));
        assert!(is_valid_summoner_name("Player Name"));
        assert!(is_valid_summoner_name("Player-Name"));
        assert!(is_valid_summoner_name("Player_Name"));
        assert!(is_valid_summoner_name("Name123"));
    }

    #[test]
    fn test_invalid_summoner_name_special_chars() {
        assert!(!is_valid_summoner_name("Player@Name"));
        assert!(!is_valid_summoner_name("Player!Name"));
    }
    ...
    #[test]
    fn test_valid_tag() {
        assert!(is_valid_tag("6433"));
        assert!(is_valid_tag("EUW"));
        assert!(is_valid_tag("NA1"));
    }

    #[test]
    fn test_invalid_tag_special_chars() {
        assert!(!is_valid_tag("TAG!"));
        assert!(!is_valid_tag("TAG#1"));
    }
}
